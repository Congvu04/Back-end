...
namespace hanhkiemUtehy.Controllers
{
    ...
    public class StudentController : BaseController
    {
        ...
        //[HttpGet("search-conduct")] 
        //public async Task<IActionResult> searchConduct(string semester, long student_id)
        //{
        //    try
        //    {
        //        var response = _studentRepository.GetFormByStudentIdAndSemester(semester, student_id);
