...
namespace hanhkiemUtehy.Repository
{
    public class StudentRepository : IStudentRepository
    {
        ...
        //public Conduct_Form GetFormByStudentIdAndSemester(string semester, long student_id)
        //{
        //    return _context.Conduct_Form.Where(r => r.student_id == student_id && r.semester.ToUpper() == semester.ToUpper()).FirstOrDefault();
        //}
    }
}
